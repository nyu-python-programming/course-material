"""
First version of a practice problem.
...
In this version, we use nested 'if' statements within the `get_age()` function.
"""
...
def get_age():
    ...
    :returns: The age, as an int, if valid.  None otherwise.
    """
    ...
    if age.isnumeric():
        ...
        if age > 150:
            # the user entered an invalid integer
            return None
        else:
